...
def main() -> None:
    ...
    # Drop the male indicator column to avoid using both one-hot gender columns.
    df_train = df_train.drop(columns=["gender_Male"], errors="ignore")
    df_test = df_test.drop(columns=["gender_Male"], errors="ignore")
